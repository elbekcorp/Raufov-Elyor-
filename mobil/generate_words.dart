...
void main() {
  final categories = {
    ...
    'numbers': [
      ...
      ['To\'qqiz', 'Nine', 'Девять'], ['O\'n', 'Ten', 'Десять'], ['Yuz', 'Hundred', 'Сто'], ['Ming', 'Thousand', 'Тысяча'],
    ],
    'colors': [
      ['Oq', 'White', 'Белый'], ['Qora', 'Black', 'Черный'], ['Qizil', 'Red', 'Красный'],
      ['Ko\'k', 'Blue', 'Синий'], ['Yashil', 'Green', 'Зеленый'], ['Sariq', 'Yellow', 'Желтый'],
    ],
  };
  ...
  print('Generated ${allWords.length} words in assets/data/words.json');
}
